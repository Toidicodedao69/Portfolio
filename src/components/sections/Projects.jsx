            ...
            <RevealOnScroll>
                <div className="max-w-5xl mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
                            <h3 className="text-xl font-bold mb-2">Path Finding Engine</h3>
                            <p className="text-gray-400 mb-4">
                                An object-oriented C# application to find optimal routes in wall mazes
                            </p>
                            <div className="flex flex-wrap gap-2 mb-4">
                                {["C#", ".NET Core", "Splashkit"].map((tech, key) => (
                                <span key={key} className="bg-blue-500/10 text-blue-500 py-1 px-3 rounded-full text-sm hover:bg-blue-500/20 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition-all">
                                    {tech}
                                </span>
                                ))}
                            ...
                            <div className="flex justify-between items-center">
                                <a href="https://github.com/Toidicodedao69/Robot-Navigation" target="_blank" className="text-blue-400 hover:text-blue-300 transition-colors my-4">
                                    View Project →
                                </a>
                            </div>
                        </div>

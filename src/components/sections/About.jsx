...
export const About = () => {
    const frontendSkills = ["React", "TypeScript", "TailwindCSS", "Bootstrap", "JavaScript"];

    const backendSkills = [".NET Core API", "MVC", "Node.js", "MongoDB", "MSSQL"];
                ...
                <div className="max-w-3xl mx-auto px-4">
                    ...
                    <div className="rounded-xl p-8 border-white/10 border hover:-translate-y-1 transition-all">
                        <p className="text-gray-300 mb-10">
                            Overview about me. I'm a passionate full stack enigneer with years of experience and creative solutions
                        </p>
                            ...
                            <div className="rounded-xl hover:translate-y-1 transition-all">
                                ...
                                <div className="space-y-4 text-gray-300">
                                    ...
                                    <ul className="list-disc list-inside text-gray-300 space-y-2">
                                        <li>
                                            Designed and developed a large language model pipeline to process text and audio streams.
                                        </li>
                                        <li>
                                            Implemented microservice architecture to scale and maintain each pipeline’s component independently.
                                        </li>
                                        <li>
                                            Used MQTT servers to handle communication between components.
                                        </li>
                                    </ul>
